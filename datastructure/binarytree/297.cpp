...
** reference: 【C++】DFS（前序遍历，递归）/BFS（层序遍历，迭代）（注释版），作者：骄阳似我，层序遍历版本
*/
...
int main(int argc, char** argv) {
    ...
    cout << "serialize result:" << ser.serialize(root) << endl;

    cout << "deserialize result:" << dser.deserialize(ser.serialize(root))->val << endl;
